...
<head>
  ...
  <link rel="icon" type="icon" href="assets/dist/img/logorumahbuku.png">
...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
	'<?php echo base_url('assets_style/image/background.png');?>')no-repeat;background-size:100%;">
<div class="login-box">
	<br/>
  <div class="login-logo">
    <a href="index.php" style="color: yellow;">Perpustakaan<br/><b>Rumah Buku</b></a>
